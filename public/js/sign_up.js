...
router.post("/",async function(req,res){
    ...
    const query = `INSERT INTO APPLICANT (NAME,DESIGNATION,DEPT,ID,DATE_OF_BIRTH,ADDRESS,EMAIL,PHONE_NUMBER,BLOOD_GROUP,RESIDENCE,PASSWORD) VALUES
    ...
    let result = await queryDB(query,[name,designation,department,id.toString(),dob,address,email,phone,blood_group,residence,password],true);
    // console.log(result);
